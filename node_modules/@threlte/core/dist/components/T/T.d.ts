 ...
 * ```
 */
export declare const T: typeof TComp & { [Key in keyof typeof THREE]: Component<Props<(typeof THREE)[Key]>, {}, "ref">; } & { [Key in keyof Threlte.UserCatalogue]: Component<Props<Threlte.UserCatalogue[Key]>, {}, "ref">; } & Record<string, Component>;
export {};
