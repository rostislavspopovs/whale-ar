<script lang="ts">import { isInstanceOf, observe, T, useTask, useThrelte } from '@threlte/core';
import { CubeCamera, Group, WebGLCubeRenderTarget } from 'three';
import { onDestroy } from 'svelte';
let { background = 'auto', far = 1000, fog = 'auto', frames = Infinity, near = 0.1, onrenderstart, onrenderstop, resolution = 256, children, ref = $bindable(), ...props } = $props();
