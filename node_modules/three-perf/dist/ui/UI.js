...
class ThreePerfUI {
  ...
  initCanvas() {
    ...
    const gpuChart = new three.Line(
      gpuChartGeometry,
      new three.LineBasicMaterial({ color: "rgb(253, 151, 31)" })
    );
    ...
    const cpuChart = new three.Line(
      cpuChartGeometry,
      new three.LineBasicMaterial({ color: "rgb(66, 226, 46)" })
    );
    ...
    const fpsChart = new three.Line(
      fpsChartGeometry,
      new three.LineBasicMaterial({ color: "rgb(238, 38, 110)" })
    );
