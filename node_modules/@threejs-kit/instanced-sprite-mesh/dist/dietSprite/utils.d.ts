...
export declare function createBufferFromListOfPoints(points: Point[]): Float32Array<ArrayBuffer>;
export declare function getUVsFromPositions(positions: Float32Array, horizontalSlices: number, verticalSlices: number, horizontalIndex: number, verticalIndex: number): Float32Array<ArrayBufferLike>;
/**
 * @param i
 * @param width
 * @param height
